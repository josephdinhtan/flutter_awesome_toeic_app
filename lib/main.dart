...
import 'data/data_providers/hive_objects/settings_hive_object/settings_hive_object.dart';
...
void main() async {
  ...
  userSettingsThemeMode =
      await GetIt.I.get<GetThemeEnableUseCase>().perform(() {});
  runApp(MyApp());
}
...
Future<void> globalInitializerForMobile() async {
  ...
  Hive.registerAdapter(SettingsHiveObjectAdapter());
  await Firebase.initializeApp(
    options: DefaultFirebaseOptions.currentPlatform,
  );
}
